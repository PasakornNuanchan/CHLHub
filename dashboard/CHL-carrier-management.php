                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Carrier Detail</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-sm-3 align-self-center ">Corporate sub name</label>
                                <div class="col-sm-9 col-md-9 col-lg-9">
                                    <input type="input" class="form-control form-control-sm inp-csname">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div style="float: right">
                                <button class="btn btn-success rounded-pill btn-sm" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);" onclick="carrier_list_set.fn_save_raw()"><i class="bi bi-check-square"></i> Save</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-xl-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-outline-primary btn-sm col-12" onclick="carrier_list_set.add_bank()">Add Bank</button>
                        </div>
                    </div>
                </div>
            </div>
