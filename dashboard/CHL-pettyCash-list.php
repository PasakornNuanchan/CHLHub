                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <button type="button" style="float: right" target="_blank" class="btn btn-success rounded-pill btn-sm bg-gradient" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);float: right;"><i class="bi bi-eye"></i> Add Petty Cash</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
