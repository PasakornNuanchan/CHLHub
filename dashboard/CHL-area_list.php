                                ...
                                <table id="datatable" class="table table-hover" data-toggle="data-table" name="data_table_list" style="border-radius: 12px; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                                    ...
                                    <tbody align="center">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $i;$i++; ?></td>
                                                <td><?= $result_table_list['location_name']?></td>
                                                <td><?= $result_table_list['provice']?></td>
                                            </tr>
                                        <?php
...
<script src="js/area_list/area_list_sent.js"></script>
<script src="js/area_list/area_list_sent_create.js"></script>
<script src="js/area_list/area_list_set.js"></script>
<script>
