...
$pdf->SetFont('THSarabunNew', 'B', 24, '', true);
...
$pdf->Cell(0, $set_height_header, "Client : ", 0, 0, 'L');
$pdf->SetX(140);
$pdf->Cell(0, $set_height_header, "ETD : ", 0, 0, 'L');
$pdf->Ln();

$pdf->Cell(0, $set_height_header, "TEL : ", 0, 0, 'L');
$pdf->SetX(140);
$pdf->Cell(0, $set_height_header, "ETA : ", 0, 0, 'L');
$pdf->Ln();

$pdf->Cell(0, $set_height_header, "POL : ", 0, 0, 'L');
$pdf->SetX(140);
$pdf->Cell(0, $set_height_header, "Page : ", 0, 0, 'L');
$pdf->Ln();

$pdf->Cell(0, $set_height_header, "POD : ", 0, 0, 'L');
$pdf->SetX(140);
$pdf->Cell(0, $set_height_header, "Issue Date : ", 0, 0, 'L');
$pdf->Ln();
$pdf->Ln();
...
$pdf->SetX(5);
$pdf->Cell(7, $height_table_head, "No.", '1', 0, 'C');
$pdf->Cell(23, $height_table_head, "Invoice no.", '1', 0,'C');
$pdf->Cell(30, $height_table_head, "MBL No.", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Container No.", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Quantity Con.", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Detail", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Unit Price", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Quantity", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Amount(RMB)", '1', 0, 'C');
$pdf->Cell(20, $height_table_head, "Amount(THB)", '1', 0, 'C');
