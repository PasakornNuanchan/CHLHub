...
foreach ($data_job_detail as $k => $v) {
  ...
  $container_exp = explode(',',$container_all);
  //print_r($test);
  $data_container = implode(",\n",$container_exp);
  ...
  $pdf->Cell(40, $set_top_detail, "Address: ", 0);
  $pdnd = $pdf->GetY();
  $pdf->SetX(110);
  ...
  $pdf->SetXY(25,$pdnd);
  $pdf->MultiCell(40, $set_top_detail, "$address", 0);
  //$pdf->Cell(40, $set_top_detail, $pdnd, 0);
  $pdnd = $pdnd+4;
  ...
  $pdf->Ln();
  $get_data_y = $pdf->GetY();
  $pdf->MultiCell(99, $set_top_detail, "Container No. : $data_container",0);
  $get_data_y_l = $pdf->GetY();

  $pdf->SetX(110);
  
  $pdf->SetXY(110,$get_data_y);
  $pdf->Cell(40, $set_top_detail, "ETD : $etd", 0);
  $pdf->Ln();
  $pdf->SetXY(10,$get_data_y_l);
