...
$data_consignee_find = isset($_POST['data_consignee_find']) ? $_POST['data_consignee_find'] : '';
$data_payment_type = isset($_POST['data_payment_type']) ? $_POST['data_payment_type'] : '';
$join_currenct_start = isset($_POST['join_currenct_start']) ? $_POST['join_currenct_start'] : '';
$join_currenct_end = isset($_POST['join_currenct_end']) ? $_POST['join_currenct_end'] : '';

// echo $data_consignee_find;
// echo $data_payment_type;
// echo $data_currency;

$data_bill_to_c = "";
if ($data_payment_type == "AR") {
...
if($join_currenct_start != ''){
    $data_currency_find = "AND currency = '$join_currenct_start'";
}


$data_having = "
HAVING 
    bill_to_c = '$data_consignee_find'
    $data_currency_find
