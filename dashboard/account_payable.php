                ...
                <div class="card-body">
                    ...
                    <div class="form-group mt-2 row">
                        ...
                        <div class="bd-example col-lg-10">
                            ...
                            <!-- </div> -->
                            <div class="form-check form-check-inline">
                                <input type="checkbox" class="form-check-input sel_st_7 input_first" onclick="ap_function.select_data('7')"name="bsradio2" name_data="7">
                                <label for="radio3" class="form-check-label pl-2">ALL</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="checkbox" class="form-check-input sel_st_1 " onclick="ap_function.select_data('1')"name="bsradio2" name_data="1">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="checkbox" class="form-check-input sel_st_8" onclick="ap_function.select_data('8')"name="bsradio2" name_data="8">
                                <label for="radio3" class="form-check-label pl-2">Pre approve</label>
                            </div>
                            <div class="form-check form-check-inline">
                    ...
                    <button class="btn btn-sm btn-outline-success" onclick="ap_function.save_function()">Save</button>
                    ...
                    <div style="zoom: 80%">
                        <div class="form-group row text-center mt-3">
                            <label class="col-xl-2">Total Payables All </label>
                        ...
                        <div class="form-group row text-center">
                            <label class="col-xl-2">Total Payable Approve</label>
                            <div class="col-xl-2 col-sm-12 col-sx-12 row">
                                <div class="col-xs-2 col-sm-2 col-xl-2">
                                    <label>USD</label>
                                </div>
