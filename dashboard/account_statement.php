                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-1 col-lg-1">
                                <select class="form-select form-select-sm inp_currency_search" onchange="start.select_filter()">
                            ...
                            <div class="col-xl-1 col-lg-1">
                                <select class="form-select form-select-sm inp_bank_account_search" onchange="start.select_filter()">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-xl-1 col-lg-1 text-center"></div>
                            <div class="col-xl-1 col-lg-1 text-center"><label for="">Start date </label></div>
                            <div class="col-xl-2 col-lg-2">
                                <input type="date" class="form-control form-control-sm inp_select_date_start" onchange="start.select_filter()">
                            </div>
                            <div class="col-xl-1 col-lg-1 text-center"><label for="">End date </label></div>
                            <div class="col-xl-2 col-lg-2">
                                <input type="date" class="form-control form-control-sm inp_select_date_end" onchange="start.select_filter()">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table table-hover table_payment" style="zoom:80%;overflow: scroll;">
                                    <thead>
                                        ...
                                        <tr class="text-center">
                                            <th>NO.</th>
                                            <th>PAYMENT TYPE</th>
                                            <th>PAYMENT<br> RECEIPT NUMBER</th>
                                            <th>Number</th>
                                            <th>Payment date</th>
...
<script src="js/account_statement/start.js"></script>
<script src="js/account_statement/start_default.js"></script>
