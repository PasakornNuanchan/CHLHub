                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div style="float: right" class="bun_save">
                                <button class="btn btn-success rounded-pill btn-sm" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);" onclick="action.save_data()"><i class="bi bi-check-square"></i> Save</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="js/my_user/setup.js"></script>
<script src="js/my_user/action.js"></script>
