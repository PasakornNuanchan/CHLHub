...
<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar ">
    <div class="container-fluid navbar-inner">
        <a href="../dashboard/CHL-home.php" class="navbar-brand">
            <!--Logo start-->
...
<div class="iq-navbar-header header-master-page" style="height: 140px;">
    <div class="container-fluid iq-container">
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="head-of-menu">China Hignwin limited Co.,ltd</h1>
                    </div>
                </div>
            </div>
        </div>
...
<div class="iq-navbar-header header-bcpage" style="height: 100px;">
