const setting_data_default = {
    ...
    setting_data : async function (id_number){
        ...
        if(res_data_default['unit'] != "0 results"){
            ...
            await $('.inp_select_packing').append(unit_data)
            await $('.inp_unit_package').append(unit_data)
        }
        ...
        if(res_data_default['bill_to_ar'] != "0 results"){
            ...
            await $('.select_bill_to_ar').append(bill_to_ar)
        }
        ...
        if(res_data_default['billing_des_ar'] != "0 results"){
            ...
            await $('.select_code_billing_ar').append(billing_des_ar)
        }
        ...
        if(res_data_default['billing_bill_to'] != "0 results"){
            ...
            await $('.inp_billing_to_ap').append(bill_to)
        }
        ...
        if(res_data_default['billing_des'] != "0 results"){
            ...
            await $('.sel_data_billing_ap').append(billing_des)
        }
        ...
        if(res_data_default['cs_data'] != "0 results"){
            ...
            await $('.inp_cs_user').append(cs_data_user)
        }
        ...
        if(res_data_default['sale_data'] != "0 results"){
            ...
            await $('.inp_sale_user').append(sale_data_user)
            
        }
        
        // console.log(res_data_default['shipper_data'])

        if(res_data_default['shipper_data'] != "0 results"){
            $.each(res_data_default['shipper_data'],function(i,v){
                shipper_data +=`<option value="${v['ID']}" data_sale="${v['sale']}">${v['shipper_name']}</option>`;
            })
            await $('#shipper_db').append(shipper_data)
        ...
        if(res_data_default['shipment_data'] != "0 results"){
            ...
            await $('#shipment_db').append(shipment_data)
        }
        ...
        if(res_data_default['consginee_data'] != "0 results"){
            ...
            await $('#consginee_db').append(consingee_data)
        ...
        if(res_data_default['carrier_data'] != "0 results"){
            ...
            await $('#carrier_data').append(carrier_data)
        }
        ...
        if(res_data_default['area_data'] != "0 results"){
            ...
            await $('#area_data').append(area_data)
            await $('#area_datal').append(area_data)
            await $('#area_datat').append(area_data)
            await $('#area_datad').append(area_data)
            await $('#area_datadl').append(area_data)

            await $('.bl_por').append(area_data)
            await $('.bl_pol').append(area_data)
            await $('.bl_pod').append(area_data)
            await $('.bl_pode').append(area_data)
        ...
        if(res_data_default['cargo_data'] != "0 results"){
            ...
            await $('#cargo_data').append(cargo_type_data)
        }
        ...
        if(res_data_default['agent_data'] != "0 results"){
            ...
            await $('#agent_data').append(agent_booking_data)
        }
        ...
        if(res_data_default['container_type_data'] != "0 results"){
            ...
            await $('#container_type_data').append(container_type_data)
        ...
        if(res_data_default['shipper_consignee'] != "0 results"){
            ...
            await $('#client_db').append(shipper_consignee)
            await $('#notify_db').append(shipper_consignee)
        }
      ...
      // transport
        ...
        if (res_data_default['supplier_data'] != "0 results") {
            ...
            await $('#sel_supplier').append(supplier_data)
        }
        ...
        if (res_data_default['truck_data'] != "0 results") {
            ...
            await $('#db_type_truck').append(truck_type_data)
        }
      ...
      // report cs
        if (res_data_default['shipping_user'] != "0 results") {
            ...
            await $('#sel_ats').append(shipping_user)
