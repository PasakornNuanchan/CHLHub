const start = {
            ...
            if(res_data['table'] != "0 results"){
                $.each(res_data['table'],function(i,v){
                    ...
                    <tr class="row_data${id_number}" id_number="${id_number}">
                        ...
                        <td class="text-center"><input type="checkbox" class="cbx_data" name="cbx_data${id_number}" style="zoom:200%;" onchange="start.cal_currency()"></td><!-- check -->
                        <td class="text-center"><input type="text" class="form-control form-control-sm inp_job_number" ></td><!-- Job number -->
        ...
        $.each(e_path,function(){
            ...
            if(data_check_prop == '1'){
                ...
                <tr class="text-center">
                    ...
                    <td><input class="form-control form-control-sm text-center" readonly value="${sysrate_to}"></td>
    ...
    condition_data_on_modal : async function(){
        ...
        $('.inp_number_payment_record').val(bdo)
        // $('.inp_amount_all').val(data_cal_currency)
        // console.log(data_cal_currency)
    },
