const setup = {
    ...
    add_list: async function () {
        let body_save = $('.card_body_save').length
        
        
        let add_html_card = `
        <div class="card-body card_body_save" style="background-color:antiquewhite">
            <h4>Add List</h4>
            <div class="row">
                <div class="col-7">
                    <div class="row">
                        <div class="col">
                            ...
                            <select class="form-select form-select-sm sel_job_number_add">
                                <option value="">-- select job number --</option>
                                ${this.data_job_number_option}
                            </select>
                        </div>
                        <div class="col">
                            <label class="form-label">Description</label>
                            <select class="form-select form-select-sm sel_description_add">
                                <option value="">-- select description --</option>
                                ${this.data_description_option}
                            </select>
                        </div>
                        <div class="col">
                            <label class="form-label">Bill to</label>
                            <select class="form-select form-select-sm sel_bill_to_add">
                                <option value="">-- select bill to --</option>
                                ${this.data_bill_to_option}
                            </select>
                        </div>
                        <div class="col">
                            <label class="form-label">Currency</label>
                            <select class="form-select form-select-sm sel_currency">
                    ...
                    <div class="row">
                        <div class="col">
                            <label class="form-label text-center">Qty</label>
                            <input type="number" class="form-control form-control-sm inp_qty_add text-end" onchange="setup.cal_data_add()">
                        </div>
                        <div class="col">
                            <label class="form-label text-center">Unit Price</label>
                            <input type="number" class="form-control form-control-sm inp_unit_price_add text-end" onchange="setup.cal_data_add()">
                        </div>
                        <div class="col">
                            <label class="form-label text-center">Sub Total</label>
                            <input type="text" class="form-control form-control-sm inp_sub_total_add text-end" disabled>
                        </div>
                        <div class="col">
                            <label class="form-label text-center">Vat(%)</label>
                            <input type="number" class="form-control form-control-sm inp_vat_add text-center" onchange="setup.cal_data_add()">
                        </div>
                        <div class="col">
                            <label class="form-label text-center">Vat Excl.</label>
                            <input type="text" class="form-control form-control-sm inp_vat_ex_add text-end" disabled>
                        </div>
                        <div class="col">
                            <label class="form-label text-center">Total</label>
                            <input type="text" class="form-control form-control-sm inp_total_add text-end" disabled>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label class="form-label text-center">Remark</label>
                            <input type="text" class="form-control form-control-sm inp_remark_add">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label class="form-label text-center">File</label>
                            <input type="file" class="form-control form-control-sm inp_file_add" onchange="readURL(this)">
                        </div>
                    </div>
                ...
                <div class="col-1"><button class="btn btn-success" onclick="action.save_data_internal()">save</button></div>
            </div>
        </div>
        `;
        ...
        if(body_save == '1'){
            $('.card_body_save').remove()
        }else{
            $('.add_list_on').html(add_html_card)
