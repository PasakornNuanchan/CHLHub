const customs_set_sub_customs = {
    ...
    set_preview_table_document: async function (job_number) {
        ...
        html_detail_des = `
                    <tr>
                        <td>Invoice : </td>
                        <td align="center"><div class="fs-5 mb-1 inv_pic_show"><i class="bi bi-file-earmark-image"></i></div></td>
                    ...
                    <tr>
                        ...
                        <td align="center"><div class="fs-5 mb-1 bl_pic_show"><i class="bi bi-file-earmark-image"></i></div></td>
                    ...
                    <tr>
                        <td>Packing list</td>
                        <td align="center"><div class="fs-5 mb-1 pl_pic_show"><i class="bi bi-file-earmark-image"></i></div></td>
                    ...
                    <tr>
                        ...
                        <td align="center"><div class="fs-5 mb-1 id_pic_show"><i class="bi bi-file-earmark-image"></i></div></td>
                    ...
                    <tr>
                        ...
                        <td align="center"><div class="fs-5 mb-1 il_pic_show"><i class="bi bi-file-earmark-image"></i></div></td>
        ...
        res_data['dts']['INV_picture'] == '' ? $('.inv_pic_show').hide('hidden',true) : '';
