const customs ={
    ...
    set_preview_data: async function (job_number){
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control form-control-sm inp-pick_emp" value=${v['pick_con_empty_address']}>
                            </div>
                            <label class="control-label col-sm-2 align-self-center mb-0">Remark :</label>
                            <div class="col">
                                <input type="text" class="form-control form-control-sm inp-pick_emp_remark" value="${v['pick_con_empty_remark']}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control inp-pick_con" value="${v['pick_con_address']}">
                            </div>
                            <label class="control-label col-sm-2 align-self-center mb-0">Remark :</label>
                            <div class="col">
                                <input type="text" class="form-control inp-pick_con_remark" value="${v['pick_con_remark']}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control inp-drop_con" value="${v['drop_con_address']}">
                            </div>
                            <label class="control-label col-sm-2 align-self-center mb-0">Remark :</label>
                            <div class="col">
                                <input type="text" class="form-control inp-drop_con_reamrk" value="${v['drop_con_remark']}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control inp-drop_emp" value="${v['drop_con_empty_address']}">
                            </div>
                            <label class="control-label col-sm-2 align-self-center mb-0">Remark :</label>
                            <div class="col">
                                <input type="text" class="form-control inp-drop_emp_remark" value="${v['drop_con_empty_remark']}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-lg-3">
                                <input type="input" style="text-align:right;" class="form-control form-control-sm inp-budget" value="${number_format(budget.toFixed(2))}">
                            </div>
                            <div class="col-lg-1">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 col-lg-3">
                        <input type="input" class="form-control form-control-sm inp-sent_request_line" value="${v['sent_line_datetime']}" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-sm-3 col-lg-2 align-self-center mb-0">Supplier Confirm DateTime :</label>
                    <div class="col-sm-3 col-lg-3">
                        <input type="input" class="form-control form-control-sm inp-supplier_firm" value="${v['sup_confirm']}" readonly>
                    </div>
                </div>
            </div>
        </div>  
        ...
        $(`.db-sel-sup${i} > select`).val(v['sup_number']); 
        $(`.db-sel-cur${i} > select`).val(v['cur']);
