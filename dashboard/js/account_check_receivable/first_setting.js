const first_setting = {
    ...
    ajax_setting_default : async function () {
        return new Promise(function (resolve, reject) {
            $.ajax({
                type: "post",
                url: "php/account_check_receivable/get_default.php",
                dataType: "json",
    ...
    setting_data_table : async function (e){
        ...
        if(res_data['table'] != "0 result"){
            ...
            $.each(res_data['table'],function(i,v){
                ...
                let paid_action = v['paid_action'] ? v['paid_action'] : '';
                ...
                <tr class=" row_master_${id_number}" id_number="${id_number}" ref_id="${ref_job_id}">
                    ...
                    <td class="text-center"><input type="checkbox" class="form-check-input cbx_sel" style="zoom:200%" onclick="function_acp.select_checked(this)"></td>
                ...
                if(paid_action != ''){
                    $(`.row_master_${id_number} > td > .cbx_sel`).attr({'checked':true,'disabled':true})
