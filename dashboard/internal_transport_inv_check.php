                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm inp_job_number" list="job_list">
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm inp_job_number" list="description_list">
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm inp_applied_person" list="bill_to_list">
